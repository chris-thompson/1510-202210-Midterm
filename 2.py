...
The vigenere function must return a shifted message. Do not shift anything that is not
...
You already know the Caesar cipher is a type of substitution cipher in which each
letter in a plaintext message is 'shifted' a certain number of places down the alphabet.
...
For example, we could shift the first character by 5, the second by 12, the third by 7,
and the fourth by 20. Then we repeat the pattern, shifting the fifth character by 5,
...
and decoding. Not too many. Not too few.
"""
